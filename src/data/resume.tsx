  ...
  projects: [
    {
      ...
      links: [
        { type: "Live", href: "https://sports.mitwpu.edu.in/", icon: <Icons.globe className="size-3" /> },
        { type: "Source", href: "https://github.com/SubhajitDolai/Courtside", icon: <Icons.github className="size-3" /> },
      ],
      image: "",
      video: "/api/videos/courtside",
    ...
    },
    {
      ...
      links: [
        { type: "Live", href: "https://infra.mitwpu.edu.in/", icon: <Icons.globe className="size-3" /> },
        { type: "Source", href: "https://github.com/SubhajitDolai/CampusBook", icon: <Icons.github className="size-3" /> },
      ],
      image: "",
      video: "/api/videos/campusbook",
    ...
    },
    {
      ...
      links: [
        { type: "Live", href: "https://www.rise-enterprises.co.in/", icon: <Icons.globe className="size-3" /> },
        { type: "Source", href: "https://github.com/SubhajitDolai/RISE", icon: <Icons.github className="size-3" /> },
      ],
      image: "",
      video: "/api/videos/rise",
    ...
    },
    {
      ...
      active: true,
      description:
        "Digital ID replaces physical paper visiting cards with a beautifully designed, always up-to-date digital alternative. Each MIT-WPU employee gets a personal digital visiting card with contact details, a scannable QR code, a 3D flip card, and a public shareable link. Features role-based admin controls, invitation-based account setup, vCard download, and a 3D physics lanyard — built to reduce printed card waste across the university.",
      technologies: [
        "Next.js",
        "TypeScript",
        "Supabase",
      ...
      image: "",
      video: "/api/videos/digitalid",
      videoPoster: "/images/digitalid-poster.jpg",
    },
    // {
